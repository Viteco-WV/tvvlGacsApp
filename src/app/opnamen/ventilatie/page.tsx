...
export default function VentilatiePage() {
  ...
  const questions = [
    {
      id: 'ventilatie_1',
      question: 'Wat is het type ventilatiesysteem in het gebouw?',
      type: 'select',
      options: ['Natuurlijke ventilatie', 'Mechanische ventilatie', 'Balansventilatie', 'Ander']
    },
    {
      id: 'ventilatie_2',
      question: 'Hoeveel ventilatie-units zijn er geïnstalleerd?',
      type: 'number'
    },
    {
      id: 'ventilatie_3',
      question: 'Wat is de totale ventilatie-capaciteit in m³/h?',
      type: 'number'
    },
    {
      id: 'ventilatie_4',
      question: 'Zijn er warmteterugwinning systemen aanwezig?',
      type: 'select',
      options: ['Ja', 'Nee', 'Gedeeltelijk']
    },
    {
      id: 'ventilatie_5',
      question: 'Wat is de leeftijd van het ventilatiesysteem?',
      type: 'select',
      options: ['0-5 jaar', '6-10 jaar', '11-15 jaar', '16-20 jaar', '20+ jaar']
    },
    {
      id: 'ventilatie_6',
      question: 'Zijn er filters geïnstalleerd?',
      type: 'select',
      options: ['Ja', 'Nee']
    },
    {
      id: 'ventilatie_7',
      question: 'Hoe vaak worden de filters vervangen?',
      type: 'text'
    },
    {
      id: 'ventilatie_8',
      question: 'Is er een onderhoudscontract voor het ventilatiesysteem?',
      type: 'select',
      options: ['Ja', 'Nee']
    }
  ];
